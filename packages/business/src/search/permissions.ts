...
export const SEARCH_ENTITY_VIEW_PERMISSION: Record<SearchEntityType, string> = {
  ...
  INVOICE: 'tenant.invoice.view',
  SALES_ORDER: 'tenant.sales.view',
  PURCHASE_ORDER: 'tenant.purchasing.view',
  PURCHASE_REQUEST: 'tenant.purchasing.view',
  PURCHASE_RFQ: 'tenant.purchasing.view',
  SUPPLIER_QUOTATION: 'tenant.purchasing.view',
  GOODS_RECEIPT: 'tenant.purchasing.view',
  PURCHASE_INVOICE: 'tenant.purchasing.view',
  PURCHASE_RETURN: 'tenant.purchasing.view',
